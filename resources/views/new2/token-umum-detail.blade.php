...
<section class="bg-light">
    <section class="container py-5">
        <div class="row mb-5">
            <div class="col-sm-12">
                <h1 class="h3 fw-bold text-center">{{$tokenSummary->tokenName}}</h1>
            </div>
        </div>
        <div class="row mb-5">
            @if ($tokenSummary)
                <div class="col-sm-12">
                    <h2 class="h2 fw-bold">@lang('site.token_umum_detail.peredaran_token')</h2>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="custom-card rounded-3">
                        <div class="custom-icon">
                            <i class="fa-solid text-theme fa-clock-rotate-left"></i>
                        </div>
                        <div class="w-100">
                            <div class="custom-token">
                                <h3 class="h5 fw-bold">Total Token</h3>
                            </div>
                            <div class="token-code" style=" display: flex; justify-content: space-between;">
                                <span>{{$tokenSummary->totalAmount}}</span>
                                <label
                                    class="badge bg-light text-dark text-uppercase">{{$tokenSummary->tokenUmumSymbol}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="custom-card rounded-3">
                        ...
                        <div class="w-100">
                            <div class="custom-token">
                                <h3 class="h5 fw-bold">@lang('site.token_umum_detail.token_tertahan')</h3>
                            </div>
                            <div class="token-code" style=" display: flex; justify-content: space-between;">
                                <span>{{$tokenSummary->currentToken}}</span>
                                <label
                                    class="badge bg-light text-dark text-uppercase">{{$tokenSummary->tokenUmumSymbol}}</label>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="custom-card rounded-3">
                        <div class="custom-icon">
                            <i class="fa-solid text-theme fa-up-right-from-square"></i>
                        </div>
                        <div class="w-100">
                            <div class="custom-token">
                                <h3 class="h5 fw-bold">@lang('site.token_umum_detail.total_penyaluran')</h3>
                            </div>
                            <div class="token-code" style=" display: flex; justify-content: space-between;">
                                <span>{{$tokenSummary->totalDistributed}}</span>
                                <label
                                    class="badge bg-light text-dark text-uppercase">{{$tokenSummary->tokenUmumSymbol}}</label>
                            </div>
                        </div>
            ...
            <div class="col-sm-12 pt-5">
                <h2 class="h2 fw-bold">@lang('site.token_umum_detail.token_penyaluran')</h2>
            </div>
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="card rounded-3">
                        <div class="card-title text-center bg-secondary-2 pt-2 rounded-3"
                            ...
                            <h3 class="h6 fw-bold">
                                {{ isset($nama_program[$results->program]) ? $nama_program[$results->program] : $results->program }}
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div>
                                    <div class="custom-token">{{ $results->programTotalAmount }}</div>
                                    <label class="text-uppercase">{{ $results->program }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <h2 class="h2 fw-bold">@lang('site.token_umum_detail.transaksi')</h2>
                ...
                @forelse ($allData as $results)
                    <div class="blockchain-item" key={index}>
                        ...
                        <div class="blockchain-column">
                            <div class="column-label">@lang('site.token_umum_detail.jumlah')</div>
                            <div class="stat-item">
                        ...
                        <div class="blockchain-column">
                            <div class="column-label">@lang('site.token_umum_detail.transaksi_hash')</div>
